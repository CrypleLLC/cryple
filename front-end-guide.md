...
| -------- | --------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `POST`   | Creates something that did not exist, or casts a vote/submission into a running process.                              | `/sign-up`, `/sign-in`, `/auth/verify`, `/secrets`, `/recovery/guardians/invite`, `/recovery/request`, `/recovery/submit`, `/auth/pin-reset/request`, `/auth/pin-reset/vote`, `/users/second-factor`, `/succession/beneficiaries`, `/succession/shares` |
...
| `POST /succession/beneficiaries` · `POST /succession/shares`                                        | ✅ safe                         | The same row (`ON CONFLICT DO UPDATE`). `/shares` re-wraps the DEK you sent.                                                                                                                                                                                      |
...
>
> The `succession-release-vote` action was **removed on 2026-09-03** together with `POST /succession/votes` and `GET /succession/votes`. Guardians take no part in releasing an inheritance; they are a recovery role.
